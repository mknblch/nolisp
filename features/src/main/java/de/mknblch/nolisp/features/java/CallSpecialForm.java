 ...
 */
@Define({"call"})
public class CallSpecialForm implements SpecialForm {

    @Override
    public Object eval(Interpreter interpreter, Context context, ListStruct args) throws Exception {
        final String methodName = TypeHelper.getSymbolLiteral(args.car());
        final Object param1 = args.cadr();
        final Object param2 = args.caddr();
        final Object param3 = args.cadddr();
        final Object[] types = TypeHelper.convertListToArray(interpreter.evalEach(TypeHelper.asList(findTypes(param1, param2, param3)), context));
        final Object[] params = TypeHelper.convertListToArray(interpreter.evalEach(TypeHelper.asList(findParams(param1, param2, param3)), context));
