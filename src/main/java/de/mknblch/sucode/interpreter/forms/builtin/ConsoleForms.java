...
public class ConsoleForms {
    ...
    public static Object print(ListStruct args, Environment env, Interpreter ip) throws Exception {
        System.out.print(ip.eval(args.car(), env));
        return null;
    }

    @Function(symbol = "printf")
    public static Object printf(ListStruct args, Environment env, Interpreter ip) throws Exception {
